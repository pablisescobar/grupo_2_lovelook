...
// Controles de imagenes en miniatura 
...
function showSlides (number) {
    let i;
    let slides = document.getElementsByClassName("slides"); //captura todos los elementos del DOM que tengan la clase Slide
    ...
    /* Si el numero recibido por parámetro es mayor a
     la cantidad de elementos que contienen la variable slides, 
